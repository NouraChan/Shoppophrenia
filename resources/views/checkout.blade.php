                                        ...
                                        <tr>
                                            <th scope="row">
                                                <div class="d-flex align-items-center mt-2">
                                                    <img src="{{$item->options->product_img}}" class="img-fluid rounded-circle" style="width: 90px; height: 90px;" alt="">
                                                </div>
                                            </th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="py-5">
                                                <div class="py-3 border-bottom border-top">
                                                    <p class="mb-0 text-dark">${{$items->subtotal}}</p>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td colspan="3" class="py-5">
                                                ...
                                                <div class="form-check text-start">
                                                    <input type="checkbox" class="form-check-input bg-primary border-0" id="Shipping-3" name="Shipping" value="pickup">
