            ...
            <div class="row g-5">
                <div class="col-md-12 col-lg-6 col-xl-7">
                    <div class="row">
                        <div class="col-md-12 col-lg-6">
                            ...
                            <div class="form-item w-100">
                                ...
                                <input type="text" value="{{$user->first_name}}" class="form-control text-capitalize" name="first_name">
                            </div>
                        </div>
                        <div class="col-md-12 col-lg-6">
                            <div class="form-item w-100">
                                <label class="form-label my-3">Last Name<sup>*</sup></label>
                                <input type="text" value="{{$user->last_name}}" class="form-control text-capitalize" name="last_name">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-item">
                        ...
                        <input type="text" value="{{$user->address}}" class="form-control text-capitalize"
                            placeholder="House Number Street Name" name="address">
                    </div>
                    <div class="form-item">
                        <label class="form-label my-3">Town/City<sup>*</sup></label>
                        <input type="text" class="form-control text-capitalize" name="city">
                    </div>
                    <div class="form-item">
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        <th scope="row">
                                            <div class="d-flex align-items-center mt-2">
                                                <img src="{{$item->options->product_img}}" class="img-fluid rounded-circle"
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" class="py-5">
                                        ...
                                        <div class="form-check text-start">
                                            <input type="checkbox" class="form-check-input bg-primary border-0"
                                                id="Shipping-2" name="Shipping" value="flatrate">
                                            <label class="form-check-label" for="Shipping-2">Flat rate: $15.00</label>
                                        </div>
                                        <div class="form-check text-start">
                                            <input type="checkbox" class="form-check-input bg-primary border-0"
                                                id="Shipping-3" name="Shipping" value="pickup">
                                ...
                                <tr>
                                    ...
                                    <td class="py-5">
                                        <div class="py-3 border-bottom border-top">
                                            ...
                                            <input type="text" hidden value="{{$grand_total}}" name="total_price">
                                        </div>
                                    </td>
                                </tr>
