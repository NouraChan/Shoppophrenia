...
@include('sweetalert::alert', ['cdn' => "https://cdn.jsdelivr.net/npm/sweetalert2@9"])
  ...
  <aside
    ...
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0 text-center" href="{{route('dash')}}">
        <span class=" ms-1 font-weight-bold">Booktopia</span>
      </a>
    </div>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link " href="{{route('wishlist.show' , ['id' => Auth::user()->id])}}">
            ...
            <span class="nav-link-text ms-1">My Wishlist</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              ...
              <li>
                  <a class="dropdown-item border-radius-md" href="{{route('user.profile' , [Auth::user()->id])}}">Profile
                  </a>
                </li>
              <li>
            ...
            <li class="nav-item px-3 d-flex align-items-center dropdown">
              <a href="{{route('home')}}" class="nav-link text-white p-0">
                <i class="fa fa-home cursor-pointer"></i>
              </a>
            </li>
