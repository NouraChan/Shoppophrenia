    ...
    <div class="container py-5">
        <div class="row g-5 align-items-center">
            <div class="col-md-12 col-lg-7">
                ...
                <h1 class="mb-5 display-3 text-primary">All Books You Can Think Of Exist Here</h1>
...
<div class="container-fluid py-5">
    <div class="container py-5">
        <div class="text-center mx-auto mb-5" style="max-width: 700px;">
            ...
            <p>Fictions picked by our specialists, promotion reward for our yearly competetion. <br> Follow our announcements for more details. </p>
        </div>
        <div class="row g-4">
